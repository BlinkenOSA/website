...
const ButtonsPage = () => {
	return (
		...
		<div className={style.PageWithMenuOpen}>
			...
			<div style={{display: 'flex', gap: '16px'}}>
				<Button type={'primary'} size={'large'} color={'neutral'}>Primary</Button>
				<Button type={'primary'} size={'large'} color={'neutral'} disabled={true}>Primary</Button>
				<Button type={'secondary'} size={'large'} color={'neutral'}>Secondary</Button>
				<Button type={'secondary'} size={'large'} color={'neutral'} disabled={true}>Secondary</Button>
				<Button type={'tertiary'} size={'large'} color={'neutral'}>Tertiary</Button>
				<Button type={'tertiary'} size={'large'} color={'neutral'} disabled={true}>Tertiary</Button>
			</div><br/>
			<h3>Mustard</h3><br/>
			<div style={{display: 'flex', gap: '16px'}}>
			...
			<h3>Icons</h3><br/>
			<div style={{display: 'flex', gap: '16px'}}>
				<Button type={'primary'} size={'medium'} color={'neutral'} isIcon={true}><IconGeneralRight/></Button>
				<Button type={'primary'} size={'medium'} color={'neutral'} isIcon={true} disabled={true}><IconGeneralRight/></Button>
			...
			<div style={{display: 'flex', gap: '16px'}}>
				<Button type={'primary'} size={'large'} color={'neutral'} isIcon={true}><IconGeneralRight/></Button>
				<Button type={'primary'} size={'large'} color={'neutral'} isIcon={true} disabled={true}><IconGeneralRight/></Button>
