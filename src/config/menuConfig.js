...
export const menuConfig = [
    {
        ...
        menuItems: [
            {
                key: 'the-archivum', title: 'The Archivum', submenu: [
                    {key: 'about-us-menu', title: 'About Us', url: '/about-us/about-the-archivum'},
                    {
                        ...
                        url: '/about-us/vera-and-donald-blinken'
                    },
            ...
            {key: 'partner-projects', title: 'Partner Projects', url: '/about-us/partner-projects'},
            {
                key: 'join-us', title: 'Join Us', submenu: [
                    {
                        key: 'visegrad-scholarship',
                        title: 'Visegrad Scholarships',
                        highlight: 'Information about the Visegrad Scholarship Program.',
                        url: '/about-us/visegrad-scholarship-at-osa'
                    },
                    {
                        key: 'jobs',
        ...
        menuItems: [
            ...
            },
            {
                key: 'selected-collections', title: 'Selected Collections', submenu: [
                    ...
                    {key: 'thematic-guides', title: 'Thematic Guides', url: '/collections/thematic-guides'}]
            },
        ...
        url: 'academics',
        menuItems: [
            {key: 'research-and-publications', title: 'Our Research', url: '/academics/our-research'},
            {
                key: 'academics-projects', title: 'Projects', submenu: [
                    {
                        key: 'academics-current-projects',
                        title: 'Current Projects',
                        highlight: "You can meet them, when you are in the Archivum.",
                        url: '/academics/current-projects'
                    },
                    {
                        key: 'academics-completed-projects',
                        title: 'Completed Projects',
                        highlight: "All the participants of the Visegrad Fellowship Program.",
                        url: '/academics/completed-projects'
                    }]
            }, {
                key: 'fellows', title: 'Fellows', submenu: [
                    {
                        ...
                        highlight: "You can meet them, when you are in the Archivum.",
                        url: '/academics/visiting-fellows'
                    }, {
                        key: 'alumni-fellows',
                        title: 'Alumni Fellows',
                        highlight: "All the participants of the Visegrad Fellowship Program.",
                        url: '/academics/alumni-fellows'
                    }]
            },
        ...
        menuItems: [
            ...
            {
                key: 'public-history-projects',
                title: 'Public History Projects',
                url: '/public-programs/public-history-projects'
            },
